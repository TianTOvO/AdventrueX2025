...
async function main() {
  console.log("🔧 检查Injective测试网合约权限...");
  ...
  try {
    ...
    if (!isOwner && !isManager) {
      ...
      console.log("- 确保MetaMask连接到Injective测试网 (Chain ID: 1439)");
      console.log("- 或者使用以下命令设置新的管理员:");
      console.log(`npx hardhat run scripts/set-manager-injective.js --network injectiveTestnet`);
    } else {
      console.log("\n✅ 当前账户有足够的权限进行操作!");
    }
    ...
    console.log("3. 合约未正确部署");
    console.log("4. 账户没有足够的INJ代币支付Gas费用");
  }
}
